...
p5.prototype.registerMethod("init", function p5playInit() {
    ...
    constructor(x, y, w, h, collider) {
      ...
      if (
        ...
        (typeof args[0] == "string" ||
          args[0] instanceof $.SpriteAnimation ||
    ...
    moveTo(x, y, speed) {
      ...
      return (async () => {
        ...
        do {
          ...
          if (
            (checkDir &&
              (this.direction <= destDMin || this.direction >= destDMax)) ||
    ...
    draw() {
      ...
      for (let i = 0; i < g.length; i++) {
        ...
        if (
          ...
          (!$.p5play._inPostDraw || sprite.autoDraw)
        ) {
          sprite.draw();
        }
      }
  ...
  $.Sprite.prototype.___step = $.Group.prototype.___step = function () {
    ...
    if (this._removed) {
      if (
        ...
        else if ($.p5play.targetVersion >= 16)
  ...
  this.World = class extends planck.World {
    ...
    step(timeStep, velocityIterations, positionIterations) {
      ...
      super.step(
        timeStep || 1 / ($._targetFrameRate || 60),
        ...
        for (let l of ["A", "B"]) {
          ...
          for (let axis of ["x", "y"]) {
            Object.defineProperty(this[prop], axis, {
              ...
              set(val) {
                _this._j["m_localAnchor" + l][axis] =
                  (val / plScale) * _this["sprite" + l].tileSize;
                if (_this.type == "distance" || _this.type == "rope") {
                  ...
                  _this._j["m_localAnchor" + o][axis] = _this._j[
                    "m_body" + o
                  ].getLocalPoint(
                    _this._j["m_body" + l].getWorldPoint(
  ...
  if (enableTextCache) {
    ...
    function _genTextImageKey(str, w, h) {
      ...
      return (
        ...
        "_" +
        (r._doStroke && r._strokeSet
          ? ctx.lineWidth + ctx.strokeStyle + "_"
          : "") +
        (w || "") +
        (h ? "x" + h : "")
      );
    ...
    $.textImage = (img, x, y) => {
      ...
      if (ctx.textBaseline == "middle")
        y -= img._descent + img._ascent * 0.5 + leadDiff;
      else if (ctx.textBaseline == "bottom")
        y -= img._ascent + img._descent + leadDiff;
  ...
  class FriendlyError extends Error {
    constructor(func, errorNum, e) {
      ...
      if (m.base) msg = m.base + ln;
        ...
        msg =
          errMsgs.generic[Math.floor(Math.random() * errMsgs.generic.length)] +
          ln;
...
p5.prototype.registerMethod("post", function p5playPostDraw() {
  ...
  if ($.p5play._fps) {
    ...
    $.p5play._fps =
      Math.round(
        1000 / ($.p5play._postDrawFrameTime - $.p5play._preDrawFrameTime)
      ) || 1;
  }
